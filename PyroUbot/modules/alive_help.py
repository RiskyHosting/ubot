...
async def _(client, message):
    ...
    sh = await message.reply("""<u><b>🏷 Join Reseller: 25.000 </b></u>
...
<blockquote>{bot.me.mention}
    status: {status} 
       {psr} expired_on: {exp} 
        ...
        <blockquote><b>USERBOT 2K/BULAN BY @risky_ubot</b></blockquote>
"""
...
async def _(client, callback_query):
    ...
    os.execl(sys.executable, sys.executable, "-m", "RISKYUBOT-PREM")
