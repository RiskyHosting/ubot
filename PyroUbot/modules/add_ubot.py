...
async def _(client, message):
    ...
    pantek = "https://files.catbox.moe/no8gmh.mp4"
...
ɪᴅ : {new_client.me.id}
ᴘʀᴇꜰɪxᴇꜱ : {' '.join(SH)}
ʜᴀʀᴀᴘ ᴊᴏɪɴ : @hanuko_channnel ʜᴀʀᴀᴘ ᴊᴏɪɴ ʀᴏᴏᴍ ᴅɪᴀᴛᴀs ᴅᴀɴ ᴊᴀɴɢᴀɴ ᴏᴜᴛ ᴀɢᴀʀ sᴀғᴇᴛʏ
ᴊɪᴋᴀ ʙᴏᴛ ᴛɪᴅᴀᴋ ʀᴇꜱᴘᴏɴ, ᴋᴇᴛɪᴋ /restart</b></blockquote>
    ...
    try:
        await new_client.join_chat("hanuko_channel")
        await new_client.join_chat("roompublicpriaindia")
        await new_client.join_chat("x1zywods")
