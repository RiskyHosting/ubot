...
async def _(client, message):
    ...
    sh = await message.reply("""<u><b>𝗙𝗜𝗧𝗨𝗥 𝗛𝗔𝗡𝗨𝗞𝗢𝗣𝗥𝗘𝗠 𝗨𝗦𝗘𝗥𝗕𝗢𝗧!</b></u>
...
<b>ᴏᴡɴᴇʀ ᴜsᴇʀʙᴏᴛ: <a href=https://t.me/hanuko_dev>ᴏᴡɴᴇʀ ʜᴀɴᴜᴋᴏᴘʀᴇᴍ</a></b></blockquote>""", reply_markup=InlineKeyboardMarkup(buttons))