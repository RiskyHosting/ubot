...
OWNER BOT : <a href=tg://openmessage?user_id={OWNER_ID}>@hanuko_dev</a> 
...
"""
    ...
    def POLICY():
        return """ <blockquote><b>ᴊɪᴋᴀ ᴀᴅᴀ ᴋᴇɴᴅᴀʟᴀ sɪʟᴀʜᴋᴀɴ ʜᴜʙᴜɴɢɪ  <a href=tg://openmessage?user_id={OWNER_ID}>@hanuko_dev</a></b></blockquote>
"""
